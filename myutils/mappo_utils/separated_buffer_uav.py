...
class SeparatedReplayBuffer(object):
    def __init__(self, args, obs_space, share_obs_space, act_space):
        self.buffer_length = args.buffer_length0
        self.rnn_hidden_size = args.hidden_size0
        self.recurrent_N = args.recurrent_N0
        self.gamma = args.gamma0
        self.gae_lambda = args.gae_lambda0
        self._use_gae = args.use_gae0
        self._use_popart = args.use_popart0
        self._use_valuenorm = args.use_valuenorm0
        self._use_proper_time_limits = args.use_proper_time_limits0
