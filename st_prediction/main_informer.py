...
parser.add_argument('--data', type=str, default='Cumtom', help='data')
parser.add_argument('--data_path', type=str,
                    default="trajectory_data/{}/{}")
parser.add_argument('--data_filename', type=str,
                    default="_trajectory_sequence_seq{}label{}pre{}.npz")
...
parser.add_argument('--seq_len', type=int, default=32, help='input sequence length of Informer encoder')
...
args.simulation_scenario = "Net4"  # "3-3-grid"/"Net4"/"bologna_pasubio"/"bologna_acosta"
args.time_range = "24h"  # "10h"/"24h"
...
for ii in range(args.itr):
    ...
    setting = '{}_{}/seq{}label{}pre{}itr{}'.format(
                args.simulation_scenario, args.time_range, args.seq_len, args.label_len, args.pred_len, ii)
